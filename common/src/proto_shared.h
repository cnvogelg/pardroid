...
#define PROTO_STATUS_NONE         0x00
#define PROTO_STATUS_DETACHED     0x10
#define PROTO_STATUS_BUSY         0x20
#define PROTO_STATUS_EVENTS       0x40
#define PROTO_STATUS_READ_PENDING 0x80
// if read is pending the lower bits are used for channel mask
