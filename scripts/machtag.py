...
machtags = {
    "avr": {
        "id": 1,
        "cpus": {"atmega328": 1, "atmega32": 2, "atmega32u4": 3},
        "machs": {"ardunano": 1, "avrnetio": 2, "teensy20": 3},
    },
    "mk20": {"id": 2, "cpus": {"mk20dx256": 1}, "machs": {"teensy32": 1}},
    "rp2": {"id": 3, "cpus": {"rp2040": 1}, "machs": {"pico": 1}},
}
